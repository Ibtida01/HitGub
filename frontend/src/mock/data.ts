import { User, Repository, Collaborator, CollabNotification } from '../types';
...
export const mockCollaborators: Collaborator[] = [
  ...
  { collaboration_id: 2, repository_id: 1, user_id: 2, role: 'maintainer', invited_by: 1, invited_at: '2025-06-02T00:00:00Z', accepted_at: '2025-06-02T12:00:00Z', status: 'accepted' },
  ...
  { collaboration_id: 7, repository_id: 2, user_id: 3, role: 'maintainer', invited_by: 1, invited_at: '2025-06-06T00:00:00Z', accepted_at: '2025-06-06T10:00:00Z', status: 'accepted' },
...
export const mockNotifications: CollabNotification[] = [
  ...
  { id: 3, type: 'role_change', message: 'Your role in github-clone was changed to maintainer', repo_name: 'github-clone', from_username: 'shakshor', created_at: '2025-06-02T14:00:00Z', read: true, target_user_id: 2 },
];
